...
import { BsInfoSquareFill } from "react-icons/bs";import { images } from '../../constants';
import './AboutUs.css';
  ...
  <div className='app__aboutus app__bg flex__center section__padding' id='about'>
    ...
    <div className="app__aboutus-content flex__center">
      <div className="app__aboutus-content_about">
        ...
        <BsInfoSquareFill style={{fontSize: '30px', color: '#EC5800', marginTop: '1rem'}} />
      ...
      <div className="app__aboutus-content_history">
        ...
        <FaHistory style={{fontSize: '27px', color: '#EC5800', marginTop: '1rem'}} />
